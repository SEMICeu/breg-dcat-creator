/*global define*/
define("rdforms/template/Choice", ["dojo/_base/declare", "../utils", "./Item"], function (declare, utils, Item) {
            ...
            if (this._dynamicChoices == null) {
                if (callback == null) {
                    ...
                    this._ontologyStore.getChoices(this, dojo.hitch(this, function (choices) {
                        sortChoices(choices);
                        if (this._dynamicChoices == null) {
                            0 && console.log("Failed lookup of choices for " + this.getLabel());
                            0 && console.log("  OntologyUrl is: " + this._source.ontologyUrl);
                        }
